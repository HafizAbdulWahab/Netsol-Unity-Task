...
{
    private readonly LatLongAltitude m_inputCoords1 = LatLongAltitude.FromDegrees(37.784468, -122.401268, 10.0);
    private readonly LatLongAltitude m_inputCoords11 = LatLongAltitude.FromDegrees(37.784318, -122.400168, 10.0);
    ...
    public GameObject m_sphereInput;
    public GameObject m_sphereOutput;
    ...
    private void OnEnable()
    {
        ...
        var options = new TransportPositionerOptionsBuilder()
            .SetInputCoordinates(m_inputCoords1.GetLatitude(), m_inputCoords1.GetLongitude())
    ...
    {
         var inputPosition = Api.Instance.SpacesApi.GeographicToWorldPoint(m_inputCoords1);
        //m_sphereInput = Instantiate(boxPrefab) as GameObject;
      ...
      //  m_sphereOutput = Instantiate(boxPrefab) as GameObject;
